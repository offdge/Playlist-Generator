...
d,e){c.fn.foundation?d||c('<div class="reveal-beerModal" data-reveal/>').append('<a class="close-reveal-beerModal" aria-label="Close">&#215;</a>').append(a&&a.header?"<h4>"+a.header(b)+"</h4>":null).append(e()).appendTo("body").foundation("reveal","open"):f(b,d,e)}};return a.Responsive});
