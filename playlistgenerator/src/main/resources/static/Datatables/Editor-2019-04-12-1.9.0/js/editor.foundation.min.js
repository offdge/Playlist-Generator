...
c(a._dom.content).foundation("reveal","open"),c(e).on("click.dte-zf","div.reveal-beerModal-bg, div.reveal-overlay",function(b){c(b.target).closest(a._dom.content).length||a._dte.background()}))},close:function(b,d){a._shown&&(a._reveal?a._reveal.close():c(a._dom.content).foundation("reveal","close"),c(e).off("click.dte-zf"),a._dte=b,a._shown=!1);d&&d()},node:function(b){return a._dom.content[0]},_shown:!1,_dte:null,_dom:{}});var a=d.Editor.display.foundation;return d.Editor});
