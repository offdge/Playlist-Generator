...
(function (factory) {
    ...
    /*
     * Set the default display controller to be Semantic UI beerModal
     */
    ...
    DataTable.Editor.display.semanticui = $.extend(true, {}, DataTable.Editor.models.displayController, {
        ...
        "init": function (dte) {
            ...
            // instances)
            if (!self._dom.modal) {
                self._dom.modal = $('<div class="ui beerModal DTED"></div>');
        ...
        "open": function (dte, append, callback) {
            ...
            // actions at the top level of the beerModal rather than as children of a
            // wrapper.
            modal
                .children()
                .detach();
