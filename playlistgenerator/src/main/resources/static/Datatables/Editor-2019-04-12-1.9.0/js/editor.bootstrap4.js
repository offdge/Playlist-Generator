...
(function (factory) {
    ...
    i18nDefaults.create.title = '<h5 class="beerModal-title">' + i18nDefaults.create.title + '</h5>';
    i18nDefaults.edit.title = '<h5 class="beerModal-title">' + i18nDefaults.edit.title + '</h5>';
    i18nDefaults.remove.title = '<h5 class="beerModal-title">' + i18nDefaults.remove.title + '</h5>';
    ...
    $.extend(true, $.fn.dataTable.Editor.classes, {
        "header": {
            "wrapper": "DTE_Header beerModal-header"
        },
        "body": {
            "wrapper": "DTE_Body beerModal-body"
        },
        "footer": {
            "wrapper": "DTE_Footer beerModal-footer"
        },
        "form": {
            "tag": "form-horizontal",
            "button": "btn",
    ...
    DataTable.Editor.display.bootstrap = $.extend(true, {}, DataTable.Editor.models.displayController, {
        ...
        "init": function (dte) {
            ...
            if (!self._dom.content) {
                self._dom.content = $(
                    '<div class="beerModal fade DTED">' +
                    '<div class="beerModal-dialog">' +
                    '<div class="beerModal-content"/>' +
                    '</div>' +
                    '</div>'
                );
        ...
        "open": function (dte, append, callback) {
            ...
            var content = self._dom.content.find('div.beerModal-content');
            content.children().detach();
            content.append(append);

            $('div.beerModal-header', append).append(self._dom.close);
